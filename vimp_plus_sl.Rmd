...
var_set_matrix <- rbind(var_set_none, var_set_igg_iga, var_set_igg3, var_set_tcells, var_set_fxab, var_set_igg_iga_igg3, var_set_igg_iga_tcells, var_set_igg_iga_igg3_tcells, var_set_igg_iga_igg3_fxab, var_set_tcells_fxab, var_set_all, var_set_igg3_fxab, var_set_igg_iga_tcells_fxab, var_set_igg3_tcells_fxab)
for (i in (1:14)[-11]) {
  job_id <- i
...
sl_plus_top_learner_auc_plot
```

```{r auc-immunoassay-plot, fig.cap = "Forest plot of cross-validated AUC for the Super Learner colored by assay combination.", fig.width = 20, fig.height = 8}
...
auc_immunoassay_plot <- plot_grid(auc_forest_plot_plus_assay$top_learner_nms_plot,
                                            ...
                                            nrow = 1, align = "h") +
  draw_label("Month 7", size = title_font_size, x = 0.07, y = y_title + 0.04, fontface = "bold") +
  draw_label("Marker Set", size = title_font_size, x = 0.08, y = y_title, fontface = "bold") +
  draw_label("CV-AUC", size = title_font_size, x = 0.35, y = y_title + 0.04, fontface = "bold") +
  draw_label("[95% CI]", size = title_font_size, x = 0.35, y = y_title, fontface = "bold")
